%% DLA Off Latice
% In this simulation before each particle moves we find the closest
% aggregated particle to it and move it this amount of distance saying that
% the particle is aggregated if it goes less than a small distance from
% another particle.
